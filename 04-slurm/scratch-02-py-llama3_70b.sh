...
/mnt/myshareddir/nvidia-verdi/nemo-workdir/nemo.collections.llm.api.pretrain/nemo.collections.llm.api.pretrain_1734454315//nemo.collections.llm.api.pretrain_sbatch.sh
